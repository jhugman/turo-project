import helper from '../lib/parser-helper.js';
  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "EditorText": parse_EditorText,
        "EditorTextLine": parse_EditorTextLine,
        "DocumentFirstParse": parse_DocumentFirstParse,
        "DocumentLineFirstParse": parse_DocumentLineFirstParse,
        "FirstParseStatement": parse_FirstParseStatement,
        "FirstParseUnitDefinition": parse_FirstParseUnitDefinition,
        "FirstParseVariableDefinition": parse_FirstParseVariableDefinition,
        "RestOfLine": parse_RestOfLine,
        "CR": parse_CR,
        "PaddedStatement": parse_PaddedStatement,
        "Statement": parse_Statement,
        "RawStatement": parse_RawStatement,
        "UnitDefinitionStatement": parse_UnitDefinitionStatement,
        "UnitDefinition": parse_UnitDefinition,
        "UnitSchemeAnnotation": parse_UnitSchemeAnnotation,
        "NewUnitDefinition": parse_NewUnitDefinition,
        "UnitAssignmentLiteral": parse_UnitAssignmentLiteral,
        "UnitDefinitionLeft": parse_UnitDefinitionLeft,
        "UnitIdentifiers": parse_UnitIdentifiers,
        "AlternativeUnitNames": parse_AlternativeUnitNames,
        ...
        "AssignmentLiteral": parse_AssignmentLiteral,
        "NumericalExpression": parse_NumericalExpression,
        "ComparatorLiteral": parse_ComparatorLiteral,
        "NumbericalExpressionUnitConversion": parse_NumbericalExpressionUnitConversion,
        ...
        "MultiplactionOperandWithoutUnit": parse_MultiplactionOperandWithoutUnit,
        ...
        "UnitIdentifierLiteral": parse_UnitIdentifierLiteral,
        "SpecialUnitLiteral": parse_SpecialUnitLiteral,
      ...
      function parse_EditorText() {
        var result0, result1;
        var pos0;
        
        pos0 = clone(pos);
        result0 = [];
        result1 = parse_EditorTextLine();
        while (result1 !== null) {
      ...
      function parse_EditorTextLine() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, node, lineEnd) {
        ...
        if (result0 === null) {
          pos0 = clone(pos);
          result0 = parse_RestOfLine();
          if (result0 !== null) {
            result0 = (function(offset, line, column, lineEnd) {
      ...
      function parse_DocumentFirstParse() {
        var result0, result1;
        var pos0;
        
        pos0 = clone(pos);
        result0 = [];
        result1 = parse_DocumentLineFirstParse();
        while (result1 !== null) {
          result0.push(result1);
          result1 = parse_DocumentLineFirstParse();
        }
      ...
      function parse_DocumentLineFirstParse() {
        var result0, result1, result2;
        var pos0, pos1;
        ...
        result0 = parse_nbsp();
        if (result0 !== null) {
          result1 = parse_FirstParseStatement();
          if (result1 !== null) {
            result2 = parse_RestOfLine();
            if (result2 !== null) {
              result0 = [result0, result1, result2];
      ...
      function parse_FirstParseStatement() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            result0 = parse_FirstParseVariableDefinition();
          }
        }
        return result0;
      }
      ...
      function parse_FirstParseUnitDefinition() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            result2 = result2 !== null ? result2 : "";
            if (result2 !== null) {
              result3 = parse_UnitDefinitionLeft();
              if (result3 !== null) {
                pos2 = clone(pos);
                result4 = parse__();
                if (result4 !== null) {
                  result5 = parse_UnitAssignmentLiteral();
                  if (result5 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, unit, colon) {
      ...
      function parse_FirstParseVariableDefinition() {
        var result0, result1, result2, result3;
        var pos0, pos1, pos2;
        ...
        if (result0 !== null) {
          result1 = parse_IdentifierLiteral();
          if (result1 !== null) {
            result2 = parse__();
            if (result2 !== null) {
              result3 = parse_AssignmentLiteral();
              if (result3 !== null) {
      ...
      function parse_RestOfLine() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, text, eol) {
              return {
                text: text.join(''),
                offsetLast: eol[0],
                lineLast: eol[1],
      ...
      function parse_PaddedStatement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, node) {
            return node;
          })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
      ...
      function parse_UnitDefinitionStatement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, unit) {
      ...
      function parse_UnitDefinition() {
        ...
        pos0 = clone(pos);
        result0 = parse_NewUnitDefinition();
        if (result0 !== null) {
          result0 = (function(offset, line, column, unit) {
        ...
        if (result0 === null) {
          pos0 = clone(pos);
          result0 = parse_UnitSchemeAnnotation();
          if (result0 !== null) {
            result0 = (function(offset, line, column, unit) {
                return unit;
              })(pos0.offset, pos0.line, pos0.column, result0);
      ...
      function parse_UnitSchemeAnnotation() {
        var result0, result1, result2, result3;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result1 = parse_AlternativeUnitNames();
          if (result1 !== null) {
            result2 = parse__();
            if (result2 !== null) {
              result3 = parse_UnitSchemes();
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, unitNode, alternatives, schemes) {
      ...
      function parse_NewUnitDefinition() {
        ...
        if (result0 !== null) {
          result1 = parse__();
          if (result1 !== null) {
            result2 = parse_UnitAssignmentLiteral();
            if (result2 !== null) {
              result3 = parse__();
              if (result3 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, id, dimension, num, unitNode) {
              return units.addUnit(id.id, num || 1.0, unitNode.unit, id.schemes, dimension, id.alternatives);
            })(pos0.offset, pos0.line, pos0.column, result0[0], result0[4], result0[6], result0[8]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, id, dimension) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              ...
              if (result1 !== null) {
                ...
                if (result2 !== null) {
                  result3 = parse__();
                  if (result3 !== null) {
                    result4 = parse_UnitAssignmentLiteral();
                    if (result4 !== null) {
                      result5 = parse__();
                      if (result5 !== null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, num, id, dimension, unitNode) {
                  return units.addUnit(id.id, unitNode.unit, num, id.schemes, dimension, id.alternatives);
                })(pos0.offset, pos0.line, pos0.column, result0[0], result0[2], result0[6], result0[8]);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
      ...
      function parse_UnitAssignmentLiteral() {
        var result0;
        
        result0 = parse_AssignmentLiteral();
        if (result0 === null) {
      ...
      function parse_UnitDefinitionLeft() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, ids, schemes) {
            return {
              id: ids[0],
              alternatives: ids[1],
              schemes: schemes
      ...
      function parse_UnitIdentifiers() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, unitName, alternatives) {
      ...
      function parse_AlternativeUnitNames() {
        var result0, result1, result2;
        var pos0, pos1;
        ...
        result1 = parse___();
        if (result1 !== null) {
          result2 = parse_NewUnitIdentifier();
          if (result2 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, alternatives) {
          var alts = [];
      ...
      function parse_UnitSchemes() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, schemeLiterals) {
      ...
      function parse_OptionalDimensionIdentifier() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, dimension) {
          return dimension;
      ...
      function parse_NewUnitIdentifier() {
        ...
        reportFailures++;
        result0 = parse_UnitIdentifierLiteral();
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
      ...
      function parse_UnitExpression() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = parse_UnitMultiplier();
            if (result2 !== null) {
              result3 = [];
              pos2 = clone(pos);
              result4 = parse_UnitMultiplicativeOperator();
              if (result4 !== null) {
                result5 = parse_UnitMultiplier();
                if (result5 !== null) {
                  result4 = [result4, result5];
                } else {
                  result4 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, optionalPer, head, tail) {
            var unitNode = head,
                op;
      ...
      function parse_UnitPerLiteral() {
        ...
        pos0 = clone(pos);
        if (input.substr(pos.offset, 3) === "per") {
          result0 = "per";
          advance(pos, 3);
        } else {
          result0 = null;
      ...
      function parse_UnitMultiplier() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, unitNode, op, num) { 
        ...
        if (result0 === null) {
          ...
          result0 = parse_UnitIdentifier();
          if (result0 !== null) {
            result0 = (function(offset, line, column, unitNode) {
                return unitNode;
              })(pos0.offset, pos0.line, pos0.column, result0);
          }
          if (result0 === null) {
      ...
      function parse_UnitIdentifier() {
        ...
        result0 = parse_UnitIdentifierLiteral();
        if (result0 !== null) {
          result1 = (function(offset, line, column, unitName) { return !!parseContext.scope.findUnit(unitName); })(pos.offset, pos.line, pos.column, result0) ? "" : null;
          if (result1 !== null) {
            result0 = [result0, result1];
          } else {
            result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, unitName) {
      ...
      function parse_IncludeStatement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, filename) {
      ...
      function parse_VariableDefinition() {
        ...
        if (result0 !== null) {
          result1 = parse__();
          if (result1 !== null) {
            result2 = parse_AssignmentLiteral();
            if (result2 !== null) {
              result3 = parse__();
              if (result3 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, identifier, definition) {
      ...
      function parse_AssignmentLiteral() {
        var result0, result1, result2;
        var pos0, pos1;
      ...
      function parse_NumericalExpression() {
        ...
        pos0 = clone(pos);
        pos1 = clone(pos);
        result0 = parse_NumbericalExpressionUnitConversion();
        if (result0 !== null) {
          pos2 = clone(pos);
          result1 = parse__();
          if (result1 !== null) {
            result2 = parse_ComparatorLiteral();
            if (result2 !== null) {
              result3 = parse__();
              if (result3 !== null) {
                result4 = parse_NumbericalExpressionUnitConversion();
                if (result4 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, lhs, operation) {
            if (operation) {
      ...
      function parse_ComparatorLiteral() {
        var result0;
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("comparator");
        }
        return result0;
      }
      
      function parse_NumbericalExpressionUnitConversion() {
        var result0, result1;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, node, unitConversion) {
            if (unitConversion) {
      ...
      function parse_UnitConversion() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, op, unitNode) {
          return [op, unitNode];
      ...
      function parse_MultiplicativeOperatorLiteral() {
        ...
        if (result0 === null) {
          if (input.charCodeAt(pos.offset) === 215) {
            result0 = "\xD7";
            advance(pos, 1);
          } else {
            result0 = null;
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              if (input.charCodeAt(pos.offset) === 247) {
                result0 = "\xF7";
                advance(pos, 1);
              } else {
                result0 = null;
      ...
      function parse_MultiplactionOperand() {
        ...
        pos0 = clone(pos);
        pos1 = clone(pos);
        result0 = parse_MultiplactionOperandWithoutUnit();
        if (result0 !== null) {
          result1 = parse_UnitExpression();
          result1 = result1 !== null ? result1 : "";
          if (result1 !== null) {
            result0 = [result0, result1];
          } else {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, node, unitNode) {
              if (unitNode) {
      ...
      function parse_MultiplactionOperandWithoutUnit() {
        var result0, result1, result2;
        var pos0, pos1, pos2;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, prefixes, operand) {
      ...
      function parse_NamedBinaryOperatorLiteral() {
        ...
        if (result0 === null) {
          ...
          result0 = parse_IdentifierLiteral();
          if (result0 !== null) {
            result1 = (function(offset, line, column, operator) {
      ...
      function parse_SpecialNamedBinaryOperator() {
        ...
        if (result0 === null) {
          if (input.charCodeAt(pos.offset) === 8730) {
            result0 = "\u221A";
            advance(pos, 1);
          } else {
            result0 = null;
      ...
      function parse_NamedPrefixUnaryOperation() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, prefixes, value) {
      ...
      function parse_SymbolTablePrefixOperator() {
        ...
        if (input.substr(pos.offset, 4) === "sqrt") {
          result0 = "sqrt";
          advance(pos, 4);
        } else {
          result0 = null;
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 === null) {
                ...
                result0 = parse_IdentifierLiteral();
                if (result0 !== null) {
                  result1 = (function(offset, line, column, literal) {
      ...
      function parse_NamedPostfixUnaryOperation() {
        ...
        if (result0 !== null) {
          ...
          result2 = parse__();
          if (result2 !== null) {
            result3 = parse_NamedPostfixOperator();
            if (result3 !== null) {
              result2 = [result2, result3];
            } else {
              result2 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, value, postfixes) {
      ...
      function parse_ValueOrParens() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, po, expression, pc) { 
      ...
      function parse_Identifier() {
        ...
        result0 = parse_IdentifierLiteral();
        if (result0 !== null) {
          result1 = (function(offset, line, column, identifier) { return parseContext.scope.findVariable(identifier); })(pos.offset, pos.line, pos.column, result0) ? "" : null;
          if (result1 !== null) {
            result0 = [result0, result1];
          } else {
            result0 = null;
      ...
      function parse_UnitIdentifierLiteral() {
        var result0;
        
        result0 = parse_SpecialUnitLiteral();
        if (result0 === null) {
          result0 = parse_IdentifierLiteral();
        }
        return result0;
      ...
      function parse_SpecialUnitLiteral() {
        var result0;
        
        if (input.charCodeAt(pos.offset) === 65020) {
          result0 = "\uFDFC";
          advance(pos, 1);
        } else {
          result0 = null;
        ...
        if (result0 === null) {
          if (input.charCodeAt(pos.offset) === 8353) {
            result0 = "\u20A1";
            advance(pos, 1);
          } else {
            result0 = null;
          ...
          if (result0 === null) {
            if (input.charCodeAt(pos.offset) === 8366) {
              result0 = "\u20AE";
              advance(pos, 1);
            } else {
              result0 = null;
            ...
            if (result0 === null) {
              if (input.charCodeAt(pos.offset) === 8358) {
                result0 = "\u20A6";
                advance(pos, 1);
              } else {
                result0 = null;
              ...
              if (result0 === null) {
                ...
                if (result0 === null) {
                  if (input.charCodeAt(pos.offset) === 163) {
                    result0 = "\xA3";
                    advance(pos, 1);
                  } else {
                    result0 = null;
                  ...
                  if (result0 === null) {
                    if (input.charCodeAt(pos.offset) === 8377) {
                      result0 = "\u20B9";
                      advance(pos, 1);
                    } else {
                      result0 = null;
                    ...
                    if (result0 === null) {
                      if (input.charCodeAt(pos.offset) === 165) {
                        result0 = "\xA5";
                        advance(pos, 1);
                      } else {
                        result0 = null;
                      ...
                      if (result0 === null) {
                        if (input.charCodeAt(pos.offset) === 8365) {
                          result0 = "\u20AD";
                          advance(pos, 1);
                        } else {
                          result0 = null;
                        ...
                        if (result0 === null) {
                          if (input.charCodeAt(pos.offset) === 402) {
                            result0 = "\u0192";
                            advance(pos, 1);
                          } else {
                            result0 = null;
                          ...
                          if (result0 === null) {
                            if (input.charCodeAt(pos.offset) === 8361) {
                              result0 = "\u20A9";
                              advance(pos, 1);
                            } else {
                              result0 = null;
                            ...
                            if (result0 === null) {
                              if (input.charCodeAt(pos.offset) === 8360) {
                                result0 = "\u20A8";
                                advance(pos, 1);
                              } else {
                                result0 = null;
                              ...
                              if (result0 === null) {
                                ...
                                if (result0 === null) {
                                  if (input.charCodeAt(pos.offset) === 8362) {
                                    result0 = "\u20AA";
                                    advance(pos, 1);
                                  } else {
                                    result0 = null;
                                  ...
                                  if (result0 === null) {
                                    if (input.charCodeAt(pos.offset) === 8369) {
                                      result0 = "\u20B1";
                                      advance(pos, 1);
                                    } else {
                                      result0 = null;
                                    ...
                                    if (result0 === null) {
                                      if (input.charCodeAt(pos.offset) === 3647) {
                                        result0 = "\u0E3F";
                                        advance(pos, 1);
                                      } else {
                                        result0 = null;
                                      ...
                                      if (result0 === null) {
                                        if (input.charCodeAt(pos.offset) === 1547) {
                                          result0 = "\u060B";
                                          advance(pos, 1);
                                        } else {
                                          result0 = null;
                                        ...
                                        if (result0 === null) {
                                          if (input.charCodeAt(pos.offset) === 6107) {
                                            result0 = "\u17DB";
                                            advance(pos, 1);
                                          } else {
                                            result0 = null;
                                          ...
                                          if (result0 === null) {
                                            if (input.charCodeAt(pos.offset) === 8363) {
                                              result0 = "\u20AB";
                                              advance(pos, 1);
                                            } else {
                                              result0 = null;
                                            ...
                                            if (result0 === null) {
                                              if (input.charCodeAt(pos.offset) === 8372) {
                                                result0 = "\u20B4";
                                                advance(pos, 1);
                                              } else {
                                                result0 = null;
      ...
      function parse_IdentifierLiteral() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, head, tail) { return head + tail.join(""); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_NumberLiteral() {
        ...
        result0 = parse_NumberLiteralString();
        if (result0 !== null) {
          result0 = (function(offset, line, column, numberObj) {
      ...
      function parse_NumberLiteralString() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, sign, valueNode, exp) {
      ...
      function parse_NumberLiteralFromParts() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, decimal) {
                return {
                  mantissa: decimal,
                  integerPart: '0',
                  literal: decimal
      ...
      function parse_ExponentLiteral() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, integer) {
          return integer;
        })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
      ...
      function parse_KeywordLiteral() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              if (input.substr(pos.offset, 4) === "test") {
                result0 = "test";
                advance(pos, 4);
              } else {
                result0 = null;
              ...
              if (result0 === null) {
                ...
                if (result0 === null) {
                  if (input.substr(pos.offset, 5) === "units") {
                    result0 = "units";
                    advance(pos, 5);
                  } else {
                    result0 = null;
      ...
      function parse__() {
        ...
        pos0 = clone(pos);
        result0 = [];
        if (/^[ \t\r\n\xA0]/.test(input.charAt(pos.offset))) {
          result1 = input.charAt(pos.offset);
          advance(pos, 1);
        } else {
          result1 = null;
      ...
      function parse_Lm() {
        ...
        if (/^[\u02B0-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0374\u037A\u0559\u0640\u06E5-\u06E6\u07F4-\u07F5\u07FA\u081A\u0824\u0828\u0971\u0E46\u0EC6\u10FC\u17D7\u1843\u1AA7\u1C78-\u1C7D\u1D2C-\u1D6A\u1D78\u1D9B-\u1DBF\u2071\u207F\u2090-\u209C\u2C7C-\u2C7D\u2D6F\u2E2F\u3005\u3031-\u3035\u303B\u309D-\u309E\u30FC-\u30FE\uA015\uA4F8-\uA4FD\uA60C\uA67F\uA717-\uA71F\uA770\uA788\uA7F8-\uA7F9\uA9CF\uAA70\uAADD\uAAF3-\uAAF4\uFF70\uFF9E-\uFF9F]/.test(input.charAt(pos.offset))) {
          result0 = input.charAt(pos.offset);
          advance(pos, 1);
        } else {
          result0 = null;
      ...
      function parse_Lt() {
        ...
        if (/^[\u01C5\u01C8\u01CB\u01F2\u1F88-\u1F8F\u1F98-\u1F9F\u1FA8-\u1FAF\u1FBC\u1FCC\u1FFC]/.test(input.charAt(pos.offset))) {
          result0 = input.charAt(pos.offset);
          advance(pos, 1);
        } else {
          result0 = null;
      ...
      function parse_Mc() {
        ...
        if (/^[\u0903\u093B\u093E-\u0940\u0949-\u094C\u094E-\u094F\u0982-\u0983\u09BE-\u09C0\u09C7-\u09C8\u09CB-\u09CC\u09D7\u0A03\u0A3E-\u0A40\u0A83\u0ABE-\u0AC0\u0AC9\u0ACB-\u0ACC\u0B02-\u0B03\u0B3E\u0B40\u0B47-\u0B48\u0B4B-\u0B4C\u0B57\u0BBE-\u0BBF\u0BC1-\u0BC2\u0BC6-\u0BC8\u0BCA-\u0BCC\u0BD7\u0C01-\u0C03\u0C41-\u0C44\u0C82-\u0C83\u0CBE\u0CC0-\u0CC4\u0CC7-\u0CC8\u0CCA-\u0CCB\u0CD5-\u0CD6\u0D02-\u0D03\u0D3E-\u0D40\u0D46-\u0D48\u0D4A-\u0D4C\u0D57\u0D82-\u0D83\u0DCF-\u0DD1\u0DD8-\u0DDF\u0DF2-\u0DF3\u0F3E-\u0F3F\u0F7F\u102B-\u102C\u1031\u1038\u103B-\u103C\u1056-\u1057\u1062-\u1064\u1067-\u106D\u1083-\u1084\u1087-\u108C\u108F\u109A-\u109C\u17B6\u17BE-\u17C5\u17C7-\u17C8\u1923-\u1926\u1929-\u192B\u1930-\u1931\u1933-\u1938\u19B0-\u19C0\u19C8-\u19C9\u1A19-\u1A1A\u1A55\u1A57\u1A61\u1A63-\u1A64\u1A6D-\u1A72\u1B04\u1B35\u1B3B\u1B3D-\u1B41\u1B43-\u1B44\u1B82\u1BA1\u1BA6-\u1BA7\u1BAA\u1BAC-\u1BAD\u1BE7\u1BEA-\u1BEC\u1BEE\u1BF2-\u1BF3\u1C24-\u1C2B\u1C34-\u1C35\u1CE1\u1CF2-\u1CF3\u302E-\u302F\uA823-\uA824\uA827\uA880-\uA881\uA8B4-\uA8C3\uA952-\uA953\uA983\uA9B4-\uA9B5\uA9BA-\uA9BB\uA9BD-\uA9C0\uAA2F-\uAA30\uAA33-\uAA34\uAA4D\uAA7B\uAAEB\uAAEE-\uAAEF\uAAF5\uABE3-\uABE4\uABE6-\uABE7\uABE9-\uABEA\uABEC]/.test(input.charAt(pos.offset))) {
          result0 = input.charAt(pos.offset);
          advance(pos, 1);
        } else {
          result0 = null;
      ...
      function parse_Mn() {
        ...
        if (/^[\u0300-\u036F\u0483-\u0487\u0591-\u05BD\u05BF\u05C1-\u05C2\u05C4-\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7-\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u08E4-\u08FE\u0900-\u0902\u093A\u093C\u0941-\u0948\u094D\u0951-\u0957\u0962-\u0963\u0981\u09BC\u09C1-\u09C4\u09CD\u09E2-\u09E3\u0A01-\u0A02\u0A3C\u0A41-\u0A42\u0A47-\u0A48\u0A4B-\u0A4D\u0A51\u0A70-\u0A71\u0A75\u0A81-\u0A82\u0ABC\u0AC1-\u0AC5\u0AC7-\u0AC8\u0ACD\u0AE2-\u0AE3\u0B01\u0B3C\u0B3F\u0B41-\u0B44\u0B4D\u0B56\u0B62-\u0B63\u0B82\u0BC0\u0BCD\u0C3E-\u0C40\u0C46-\u0C48\u0C4A-\u0C4D\u0C55-\u0C56\u0C62-\u0C63\u0CBC\u0CBF\u0CC6\u0CCC-\u0CCD\u0CE2-\u0CE3\u0D41-\u0D44\u0D4D\u0D62-\u0D63\u0DCA\u0DD2-\u0DD4\u0DD6\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0EB1\u0EB4-\u0EB9\u0EBB-\u0EBC\u0EC8-\u0ECD\u0F18-\u0F19\u0F35\u0F37\u0F39\u0F71-\u0F7E\u0F80-\u0F84\u0F86-\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102D-\u1030\u1032-\u1037\u1039-\u103A\u103D-\u103E\u1058-\u1059\u105E-\u1060\u1071-\u1074\u1082\u1085-\u1086\u108D\u109D\u135D-\u135F\u1712-\u1714\u1732-\u1734\u1752-\u1753\u1772-\u1773\u17B4-\u17B5\u17B7-\u17BD\u17C6\u17C9-\u17D3\u17DD\u180B-\u180D\u18A9\u1920-\u1922\u1927-\u1928\u1932\u1939-\u193B\u1A17-\u1A18\u1A1B\u1A56\u1A58-\u1A5E\u1A60\u1A62\u1A65-\u1A6C\u1A73-\u1A7C\u1A7F\u1B00-\u1B03\u1B34\u1B36-\u1B3A\u1B3C\u1B42\u1B6B-\u1B73\u1B80-\u1B81\u1BA2-\u1BA5\u1BA8-\u1BA9\u1BAB\u1BE6\u1BE8-\u1BE9\u1BED\u1BEF-\u1BF1\u1C2C-\u1C33\u1C36-\u1C37\u1CD0-\u1CD2\u1CD4-\u1CE0\u1CE2-\u1CE8\u1CED\u1CF4\u1DC0-\u1DE6\u1DFC-\u1DFF\u20D0-\u20DC\u20E1\u20E5-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302D\u3099-\u309A\uA66F\uA674-\uA67D\uA69F\uA6F0-\uA6F1\uA802\uA806\uA80B\uA825-\uA826\uA8C4\uA8E0-\uA8F1\uA926-\uA92D\uA947-\uA951\uA980-\uA982\uA9B3\uA9B6-\uA9B9\uA9BC\uAA29-\uAA2E\uAA31-\uAA32\uAA35-\uAA36\uAA43\uAA4C\uAAB0\uAAB2-\uAAB4\uAAB7-\uAAB8\uAABE-\uAABF\uAAC1\uAAEC-\uAAED\uAAF6\uABE5\uABE8\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE26]/.test(input.charAt(pos.offset))) {
          result0 = input.charAt(pos.offset);
          advance(pos, 1);
        } else {
          result0 = null;
      ...
      function parse_Nl() {
        ...
        if (/^[\u16EE-\u16F0\u2160-\u2182\u2185-\u2188\u3007\u3021-\u3029\u3038-\u303A\uA6E6-\uA6EF]/.test(input.charAt(pos.offset))) {
          result0 = input.charAt(pos.offset);
          advance(pos, 1);
        } else {
          result0 = null;
      ...
      function parse_Pc() {
        ...
        if (/^[_\u203F-\u2040\u2054\uFE33-\uFE34\uFE4D-\uFE4F\uFF3F]/.test(input.charAt(pos.offset))) {
          result0 = input.charAt(pos.offset);
          advance(pos, 1);
        } else {
          result0 = null;
